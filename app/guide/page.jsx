    ...
    <div>
      ...
      <div className="wrap">
        ...
        <Section title="3. 결제 안내">
          <p>현재는 <b style={{ color: "var(--ink)" }}>계좌이체</b>로 주문을 받고 있으며, 신용·체크카드 결제는 결제대행사(토스페이먼츠) 계약 완료 후 오픈될 예정이에요. 계좌이체는 주문 접수 후 안내되는 계좌로, 반드시 <b style={{ color: "var(--ink)" }}>발송인(주문자) 성함과 동일한 이름</b>으로 입금해주셔야 확인이 빠릅니다.</p>
          <p>입금 확인 전까지는 "내 주문 확인"에서 수취인 정보와 요청사항(비고)을 직접 수정할 수 있어요.</p>
        </Section>

        <Section title="4. 배송 안내">
          <p>입금 확인 후 공휴일 제외 2일 이내에 발송됩니다. 신선도 유지를 위해 냉장·냉동 포장으로 발송돼요.</p>
        ...
        <Section title="6. 환불 안내">
          <p>안내드린 발송 예정일보다 <b style={{ color: "var(--ink)" }}>3일 이상 지연</b>되는 경우 주문을 취소하고 전액 환불받을 수 있어요. "내 주문 확인"의 취소 요청 또는 고객센터로 알려주세요.</p>
