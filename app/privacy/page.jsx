    ...
    <div>
      ...
      <div className="wrap">
        ...
        <Article title="3. 처리하는 개인정보 항목">
          <p>① 회원가입(일반): 전화번호, 비밀번호</p>
          <p>② 회원가입(소셜 로그인): 카카오·네이버 계정 식별자, 이름 또는 닉네임, 전화번호</p>
          <p>③ 주문·배송: 발송인(주문자) 성함·주소·전화번호, 수취인 성함·주소·전화번호</p>
          <p>④ 서비스 이용 과정에서 접속 로그, 이용기록 등이 생성되어 수집될 수 있습니다.</p>
          <p>※ 소셜 로그인 이용 시 카카오·네이버가 이용자 동의를 받아 제공하는 정보만 수집하며, 각 서비스의 개인정보처리방침이 함께 적용됩니다.</p>
        </Article>
        ...
        <Article title="10. 개인정보 보호책임자">
          ...
          <p>- 성명: 성욱진 (대표)</p>
          <p>- 이메일: contact@dandan-shop.co.kr</p>
