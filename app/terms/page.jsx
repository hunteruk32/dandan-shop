...
export default function TermsPage() {
  return (
    <div>
      ...
      <div className="wrap">
        <PageTitleRow title="이용약관" />
        <p style={{ fontSize: 12, color: "var(--muted)", marginBottom: 20 }}>시행일: 2026년 9월 21일 (제10조 ② 개정: 배송 지연 시 취소·환불 안내 추가 — 이용자에게 유리한 변경으로 즉시 적용 / 종전 시행일 2026년 9월 7일)</p>
        ...
        <Article title="제10조 (배송)">
          ...
          <p>② 발송은 결제(입금 확인) 후 공휴일 제외 2일 이내를 원칙으로 합니다. 천재지변, 산지 사정 등 불가피한 사유로 지연될 경우 회사는 이용자에게 사전 안내하며, 안내한 발송 예정일보다 3일 이상 지연되면 이용자는 주문을 취소하고 대금 전액을 환불받을 수 있습니다. 도서·산간지역은 추가 배송비가 발생할 수 있습니다.</p>
        </Article>
