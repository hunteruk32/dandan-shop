// 카카오톡 오픈채팅방에서 실제 구매고객이 남긴 후기 (닉네임은 카카오 오픈채팅 익명 프로필명)
export const TESTIMONIALS = [
  { keywords: ["옥수수"], text: "옥수수 신선하니 맛있어요", author: "구매고객" },
  {
    keywords: ["찰옥수수", "옥수수"],
    text: "찰옥수수 쫄깃쫄깃하니 맛있습니다. 초당옥수수에 이어 찰옥수수도 품질이 아주 좋네요.",
    author: "Doubletaek",
  },
  { keywords: ["장어"], text: "장어 정말 실하네요 ㅎㅎ", author: "다울 김로은 아빠" },
  {
    keywords: ["젓갈", "낙지"],
    text: "낙지젓갈 완전 추천해요. 적당히 매콤하고 양념 맛있어요. 다리도 통통하니 실합니다.",
    author: "축하하는 라이언",
  },
  { keywords: ["곱창"], text: "소곱창구이!! 넘 맛있어요!!!!", author: "우는 라이언" },
  { keywords: ["전어"], text: "전어파티입니다. 생와사비에 쌈장까지 들어있네요.", author: "축하하는 라이언" },
  { keywords: ["꽃게"], text: "꽃게 살 많고 맛있어요 👍👍", author: "파티하는 어피치" },
  { keywords: ["홍어"], text: "이번 주말은 홍어네요, 색 좋아요 ㅎ", author: "축하하는 라이언" },
  {
    keywords: ["수박"],
